...
// These are the fields that I need to work with in the form even though there are other fields in this table
export const insertCustomerSchema = createInsertSchema(customers, {
  ...
  state: (schema) => schema.state.length(2, 'State must be two characters'),
